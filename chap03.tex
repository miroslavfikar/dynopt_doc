...
profile is of value of 1.204784e-01 after 359 iterations with exitflag
...
(421 vs 659) based on expresion for the gradient $\partial
...
\end{verbatim}
The multiplication order specified in the file \subor{processd.m} gave
the same optimum as \fun{fmincon}.
