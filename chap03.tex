...
is returned after 611 iterations in before mentioned output structure
\argfun{optimout} as parameter \argfun{fval}:
\begin{verbatim}
optimout.fval = 0.7615959
\end{verbatim}
...
\fun{dynopt} input and output arguments, see chapter
\ref{cha:reference}. 
...
solution is 0.9242346 after 368 iterations (10000 function
evaluations) and with exitflag equal to~0 (limit of function
evaluations).
...
the solution is shown in Figs. \ref{fig:car2_u},  \ref{fig:car2_x2}, and \ref{fig:car2_x1}.
