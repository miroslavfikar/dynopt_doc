...
options = sdpoptionset('LargeScale','on','Display','iter','TolFun',1e-7,...
                       ...
                       'MaxFunEvals',1e5,'MaxIter',150,'Algorithm','sqp',...
                       'NLPsolver','fmincon');
optimparam.optvar = 3;
optimparam.objtype = [];
optimparam.ncolx = 5;
optimparam.ncolu = 2;
optimparam.li = ones(10,1)*(1/1.5);
optimparam.tf = [];
optimparam.ui = ones(1,10)*6;
optimparam.par = [];
optimparam.bdu = [0 12];
optimparam.bdx = [];
optimparam.bdp = [];
