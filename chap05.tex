...
closer value of performance index of 0.57338 to the reported global
maximum (2794 iterations, exitflag equal to~5). The optimal control
...
obtained optimal value of 0.610756 (1781 iterations, exitflag equal
to~5), by using 5 collocation points for state variables and keeping
control variable profile as piecewise linear on 4 time intervals. This
is quite closer to the global one. The optimal control and state
profiles are given in Figs.~\ref{fig:prob5_u} and \ref{fig:prob5_x}.
...
using~\fun{dynopt} was 0.477457 (214 iterations, exitflag equal
to~5). In this case 5 collocation points for state variables and
2 collocation points for control variables were chosen. The number of
time-intervals have been set to 12. The optimal control and state
profiles are given in Figs.~\ref{fig:prob6_u} and \ref{fig:prob6_x}.
...
optimum was found at value of 21.7632 (1665 iterations, exitflag equal
to~5). The optimal control profiles are given in
Figs. \ref{fig:prob7_u1}, \ref{fig:prob7_u2}, \ref{fig:prob7_u3},
\ref{fig:prob7_u4} and optimal state profiles are represented in
Fig.~\ref{fig:prob7_x}.
