...
{\small \verbatiminput{examples/problem_pr_bior/process.m}}

\paragraph{Step2: Write an M-file~\subor{objfun.m}}

{\small \verbatiminput{examples/problem_pr_bior/objfun.m}}

\paragraph{Step3: Write an M-file~\subor{confun.m}}

{\small \verbatiminput{examples/problem_pr_bior/confun.m}}

\paragraph{Step4: Invoke~\fun{dynopt}} writing an
M-file~\subor{problem.m} as follows: 

{\small \verbatiminput{examples/problem_pr_bior/problem.m}}
